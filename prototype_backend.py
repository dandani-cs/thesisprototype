...
#importing the yolo model and functions
...
model_name = 'capsnet_1600_0005LW.h5'
...
def _main(file):
    ...
    input_w, input_h = 544, 544 #set input height and width for yolov3 model 
    ...
    cv2.imwrite("detected/"+image_name, main_frame)
    return main_frame, label
